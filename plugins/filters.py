...
async def filter(client: Bot, message: Message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        await message.reply_text(
                f"<b> Here is the result for @Tentkotta_Tamil{message.text}</b>",
                reply_markup=InlineKeyboardMarkup(buttons)
            )    
    ...
    if (clicked == typed) or (clicked in AUTH_USERS):
        ...
        if query.data.startswith("next"):
            ...
            keyboard = InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/Tentkotta_Tamil")]
            ])
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("BACK", callback_data="start_data"),
                    InlineKeyboardButton("ABOUT", callback_data="about_data")],
                [InlineKeyboardButton("⭕️ SUPPORT ⭕️", url="https://t.me/Tentkotta_Tamil")]
            ])
